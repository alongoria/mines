/* CSCI261 Homework 23: stringTest
 *
...
string capitalize(string s) {
	...
	string z = s.substr(1,s.length());
	char g = char(s[0] - 32);
	string stuff = string(1,g);
	return stuff.append(z); 
}
